...
//	GET PAGE URLS INTO LIST FOR COLOR DOMAIN TO USE IN LEGEND
...
// 		.range(["#aad", "#556"]);	
	...
	{
		coldomain2[color.domain()[i]]=color.range()[i]
	};

// 	console.log('colorlist',coldomain2);
...
// 				console.log('wordObj',wordObj)
				txtline='<br><b><span class="keyword">Keyword:'+d+'</span></b></br>';
	...
	// 				console.log('sent',wordObj[urlObj]['sent']);
					if (sentObj=wordObj[urlObj]['count']>0)
					{
						//console.log('urlObj',urlObj);
						console.log('color[urlObj]',color);
						txtline=txtline.concat('<br><b>URL:</b><span class="urlobj"><font color=',coldomain2[urlObj],'>',urlObj,'</font color></br>');
